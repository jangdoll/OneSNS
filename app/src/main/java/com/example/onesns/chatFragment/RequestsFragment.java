package com.example.onesns.chatFragment;
...
import com.example.onesns.chatModel.Requests;
import com.example.onesns.chatProfile.ChatProfileActivity;
                                                                                                ...
                                                                                                .addOnCompleteListener(task111 -> {
                                                                                                    if (task111.isSuccessful()) {
                                                                                                        ...
                                                                                                        Snackbar snackbar = Snackbar
                                                                                                                .make(view, getString(com.example.onesns.R.string.now_your_friend), Snackbar.LENGTH_LONG);
                                                                    ...
                                                                    friendReqDatabaseReference.child(userID).child(user_UId).removeValue()
                                                                            .addOnCompleteListener(task12 -> {
                                                                                if (task12.isSuccessful()) {
                                                                                    ...
                                                                                    @SuppressLint("WrongConstant")
                                                                                    Snackbar snackbar = Snackbar
                                                                                            .make(view, getString(com.example.onesns.R.string.cancel_request), Snackbar.LENGTH_LONG);
                                                                                    // Changing message text color
                                                                                    View sView = snackbar.getView();
                                                                                    sView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.colorPrimary));
                                                                                    TextView textView = sView.findViewById(com.google.android.material.R.id.snackbar_text);
                            ...
                            if (requestType.equals("sent")) {
                                ...
                                userDatabaseReference.child(userID).addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        holder.itemView.setOnClickListener(v -> {
                                            CharSequence options[] = new CharSequence[]{getString(R.string.cancel_friend_request), userName + getString(com.example.onesns.R.string.users_profile)};
