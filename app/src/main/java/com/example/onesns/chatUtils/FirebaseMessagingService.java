...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        String NOTIFICATION_CHANNEL_ID = "OenSNS_Channel_1";
        CharSequence name = "OenSNS";

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "OenSNS Notifications", NotificationManager.IMPORTANCE_LOW);
